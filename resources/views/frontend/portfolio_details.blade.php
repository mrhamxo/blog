                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="breadcrumb__wrap__content">
                            <h2 class="title">{{ $portfolioDetails->portfolio_name }}</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ $portfolioDetails->portfolio_name }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="services__details__content">
                            <h2 class="title">{{ $portfolioDetails->portfolio_title }}</h2>
